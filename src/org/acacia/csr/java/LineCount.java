...
public class LineCount {
    ...
    public static void main(String[] args) throws Exception {
        /*
         * String dir1 = "/user/miyuru/wcout"; String dir2 =
         * "/user/miyuru/lcout"; //We first delete the temporary directories if
         * they exist on the HDFS FileSystem fs1 = FileSystem.get(new
         * JobConf());
         * 
         * if(fs1.exists(new Path(dir2))){ fs1.delete(new Path(dir2), true); }
         * 
         ...
         * 
         * Job job = new Job(conf, "line count"); job.waitForCompletion(true);
         * org.apache.hadoop.mapreduce.Counters cntr = job.getCounters(); System
         * .out.println("Number of lines in the file" +
         * cntr.findCounter("org.apache.hadoop.mapred.Task$Counter",
        ...
        edgeCount = cntr.findCounter("org.apache.hadoop.mapred.Task$Counter",
                "MAP_INPUT_RECORDS").getValue();
        ...
        // edgeCount = edgeCount -1;//This is to remove the line number
        // additionlly added to each edgelist file by HDFS. This is strange, but
        // it happens.
