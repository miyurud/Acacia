    ...
    public void map(Object key, Text value, Context context
      ...
      while (itr.hasMoreTokens()) {
    	  if(itr.nextToken().equals("0")){
    		  ...
    		  FSDataOutputStream out = fs.create(new Path("/user/miyuru/zout/zout"));
    		  out.writeUTF("1");
    		  out.close();
    		  
    		  throw new ZeroFoundException("Vertex 0 was found in Task : " + context.getTaskAttemptID().getTaskID().getId());
    	  }
      }
    }
  }
