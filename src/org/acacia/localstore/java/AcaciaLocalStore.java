...
public class AcaciaLocalStore extends java.lang.Thread {
    ...
    public void initialize(){
    	if((graphID != -1) && (partitionID != -1)){
    		dataFolder = Utils_Java.getAcaciaProperty("org.acacia.server.localstore.datafolder") + File.separator + graphID + "_" + partitionID;
    	}else{
    		dataFolder = Utils_Java.getAcaciaProperty("org.acacia.server.localstore.datafolder");
    	}
