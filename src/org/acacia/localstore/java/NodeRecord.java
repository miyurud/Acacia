...
/**
 * The node record is a unit of storage for the information specific to a vertex.
 * This class should contain only the information pertaining to a specific one vertex and its associated
 * property(i.e., attribute) information.
 */
