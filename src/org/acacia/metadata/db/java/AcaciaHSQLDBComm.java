...
public class AcaciaHSQLDBComm {
    ...
    public AcaciaHSQLDBComm() {
        String hsqldbhost = Utils_Java
                .getAcaciaProperty("org.acacia.metadata.db.host");
        String hsqldbport = Utils_Java
                .getAcaciaProperty("org.acacia.metadata.db.port");
        connectionString = "jdbc:hsqldb:hsql://" + hsqldbhost + ":"
                + hsqldbport + "/acacia_meta;ifexists=true";
    }
    ...
    public static boolean setupAcaciaMetaDataDB() {
        ...
        try {
            ...
            System.out
                    .println("The DB schema ACACIA does not exists. Continuing...");
        }
