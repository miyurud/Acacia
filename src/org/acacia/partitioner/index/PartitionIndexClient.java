    ...
    public static void loadIndex() {
        ...
        try {
            Socket socket = new Socket(host,
                    Conts_Java.ACACIA_PARTITION_INDEX_PORT); // This goes to the
                                                             // local host
            ...
            if ((response != null)
                    && (response
                            .equals(PartitionIndexProtocol.CREATE_INDEX_ACK))) {
                ...
                if ((response != null)
                        && (response.equals(PartitionIndexProtocol.EXIT_ACK))) {
            ...
            Logger_Java.error("==> host : " + host + " port : "
                    + Conts_Java.ACACIA_PARTITION_INDEX_PORT);
