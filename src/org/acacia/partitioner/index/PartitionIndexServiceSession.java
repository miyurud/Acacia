...
public class PartitionIndexServiceSession extends Thread {
    ...
    public PartitionIndexServiceSession(PartitionIndexObject obj2, Socket skt,
            PartitionIndex ref) {
        obj = obj2;
        sessionSkt = skt;
        refToObj = ref;
    ...
    public void run() {
        // System.out.println("Started PartitionIndexServiceSession theard : " +
        // Thread.currentThread().getId());
        try {
            BufferedReader buff = new BufferedReader(new InputStreamReader(
                    sessionSkt.getInputStream()));
    ...
    /**
     * This method processes the query requests to AcaciaForntEnd. This is the
     * main function that answers the queries.
     */
    public void process(String msg, BufferedReader buff, PrintWriter out)
            throws IOException {
        String str = null;

        if (msg.equals(PartitionIndexProtocol.PARTITION_ID_REQ)) {// List the
                                                                  // graphs on
                                                                  // Acacia
            out.println(PartitionIndexProtocol.SEND_VERT_ID); // Sometimes this
                                                              // might
                                                              // introduce
                                                              // additional
                                                              // overhead for
            ...
            // System.out.println(" for vertex : " + vval +
            // " the resolved result is : " + vval2);
            ...
            while (!str
                    .equals(PartitionIndexProtocol.BATCH_PARTITION_ID_REQ_DONE)) {
