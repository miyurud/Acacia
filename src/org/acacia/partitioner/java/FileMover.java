...
public class FileMover {
    public static class FileMoverMapper extends MapReduceBase
            implements
        ...
        public void map(LongWritable arg0, Text value,
            ...
            String newPath = "/user/miyuru/edgedistributed-out/" + v3 + "/"
                    + v2;
            ...
            FileUtil.copy(fs1, new Path(v), fs1, new Path(newPath), false,
                    new JobConf());
        }
    }
