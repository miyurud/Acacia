...
public class AcaciaGraphQuery implements com.tinkerpop.blueprints.GraphQuery {
    ...
    public AcaciaGraphQuery has(String key, AcaciaPredicate predicate,
            Object value) {
        return null;
    }
    ...
    public <T extends Comparable<T>> com.tinkerpop.blueprints.GraphQuery has(
            String a1, T a2, com.tinkerpop.blueprints.Query.Compare a3) {
        return null;
    }

    public <T extends Comparable<?>> com.tinkerpop.blueprints.GraphQuery interval(
            String a1, T a2, T a3) {
        return null;
    }
