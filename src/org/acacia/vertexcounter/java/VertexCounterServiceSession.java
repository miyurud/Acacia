...
public class VertexCounterServiceSession extends Thread {
    ...
    public VertexCounterServiceSession(Socket socket,
            VertexSingleton singletonObj) {
    ...
    public void process(String msg, BufferedReader buff, PrintWriter out) {
        ...
        if (msg.equals(VertexCounterProtocol.TICKET)) {// List the graphs on
                                                       // Acacia
            ...
            if (r != -1) {
                ...
                response = VertexCounterProtocol.ERROR
                        + ":The specified graph id does not exist";
            }
            ...
            if (obj.save()) {
                ...
                out.println("" + VertexCounterProtocol.ERROR
                        + ":could not complete saving the vertex count values.");
                out.flush();
            }
