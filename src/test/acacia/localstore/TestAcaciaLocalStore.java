...
public class TestAcaciaLocalStore {
    public static void main(String[] args) {
        ...
        // AcaciaHashMapLocalStore localStore = new
        // AcaciaHashMapLocalStore(276,934);
        // localStore.loadGraph();
        //
        // String result = Triangles.run(localStore, "276", "934", null);

        // AcaciaHashMapLocalStore localStore =
        // loadDataSet("/home/miyurud/Acacia/graphs/Roadnet-PA/roadNet-PA.txt");
        ...
        try {
            ...
            if (line != null) {
                if (line.contains(" ")) {
                    ...
                    System.out
                            .println("Error : Could not find the required splitter character ...");
                }
            }

            // Here first we need to scan through the file one round and see
            // whether the file contains a zero vertex.
            // If it contains a zero vertex we have to treat it separately. So
            // that will be done in the second round.

            while (line != null) {
                Iterator<String> dataStrIterator = splitter.split(line)
                        .iterator();
            ...
            while (line != null) {
                ...
                localStore.addEdge(new Long(firstVertex.intValue()), new Long(
                        secondVertex.intValue()));
