...
public class TestPartitionIndexClient {
    ...
    public static void main(String[] args) {   	   	
    	...
    	java.sql.Connection c = org.acacia.centralstore.java.HSQLDBInterface.getConnection(gid, partid);
    	...
    	System.out.println("==============================================================================================7");
 		...
 		try{
 			...
 			//java.sql.ResultSet rs = stmt.executeQuery("SELECT idfrom,idto FROM \"ACACIA_CENTRAL\".\"EDGEMAP\" where idgraph=" + gid + ";" );
 			//java.sql.ResultSet rs = stmt.executeQuery("SELECT idfrom,idto FROM EDGEMAP where idgraph=" + gid + ";" );
 
 			//SELECT * FROM   INFORMATION_SCHEMA.TABLES
 			
// 			java.sql.ResultSet rs = stmt.executeQuery("SELECT DISTINCT TABLE_SCHEMA FROM   INFORMATION_SCHEMA.TABLES;" );
// 			int counter = 0;
// 			if(rs != null){
// 					while(rs.next()){
...
// 			System.out.println("count : " + counter);
 			...
 			java.sql.ResultSet rs = stmt.executeQuery("SELECT idfrom,idto FROM acacia_central.edgemap where idgraph=229;");
